  ...
  return (
    <div className='section-container'>
      ...
      <p dangerouslySetInnerHTML={{ __html: text }}></p>
        <img className='section-img' src={`/fuzzbeed/${imgUrl}`} />
    </div>
  )
}
...
function Article() {
  const sections = [
    ...
    },
    {
      ...
      imgUrl: "dinner_with_dumtek.jpeg"
    },
    {
