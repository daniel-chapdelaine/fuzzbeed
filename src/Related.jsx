  ...
  return (
    <div className='related-container'>
      ...
      <div className='articles-container'>
        <ArticleLink
          imgSrc={import.meta.env.VITE_ASSET_PATH + 'public/gnome.jpg'}
        ...
        <ArticleLink
          imgSrc={import.meta.env.VITE_ASSET_PATH + 'public/mining.jpg'}
        ...
        <ArticleLink
          imgSrc={import.meta.env.VITE_ASSET_PATH + 'public/trickster.jpg'}
